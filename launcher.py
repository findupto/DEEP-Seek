...
# The canonical App already builds its responsive shell in build_shell().
# Do not install the legacy ui_responsive_patch: it expects App.build(),
# which no longer exists and causes startup failure.
install(pos_app.App)
